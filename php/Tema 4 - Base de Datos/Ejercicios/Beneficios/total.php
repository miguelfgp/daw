...
<div id="main">
    ...
    <?php
        ...
        $query_gastos = $mysqli->query('SELECT num_semana, gasto FROM gastos');
        $query_ventas = $mysqli->query('SELECT num_semana, venta FROM ventas');
        ...
        $query_total_ventas = $mysqli->query('SELECT SUM(gasto) FROM gastos');
        $query_total_gastos = $mysqli->query('SELECT SUM(venta) FROM ventas');
