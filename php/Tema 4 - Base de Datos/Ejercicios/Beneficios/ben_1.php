...
<body>
    ...
    <?php
        ...
        $query_gastos = $mysqli->query('SELECT num_semana, gasto FROM gastos WHERE num_semana=1');
        $query_ventas = $mysqli->query('SELECT num_semana, venta FROM ventas WHERE num_semana=1');
        ...
        $query_total_ventas = $mysqli->query('SELECT SUM(gasto) FROM gastos WHERE num_semana=1');
        $query_total_gastos = $mysqli->query('SELECT SUM(venta) FROM ventas WHERE num_semana=1');
